...
//     };
// };
export const getVerificationEmailTemplate = (code, userEmail) => {
    const escapeHtml = (s = "") => {
        return String(s).replace(/[&<>"'\/]/g, (c) => ({
            '&': '&amp;',
            '<': '&lt;',
...
export const getPasswordResetEmailTemplate = (resetUrl, userEmail, resetToken) => {
    const escapeHtml = (s = "") => {
        return String(s).replace(/[&<>"'\/]/g, (c) => ({
            '&': '&amp;',
            '<': '&lt;',
...
export const getPasswordResetSuccessTemplate = (userEmail) => {
    const escapeHtml = (s = "") => {
        return String(s).replace(/[&<>"'\/]/g, (c) => ({
            '&': '&amp;',
            '<': '&lt;',
