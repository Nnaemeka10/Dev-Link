...
// const MOBILE_SERVICES = MOBILE_EXPLORE_LISTINGS.filter((l) => l.kind === "service");
// const DESKTOP_SERVICES = DESKTOP_EXPLORE_LISTINGS.filter((l) => l.kind === "service");
...
//     () => MOBILE_SERVICES.filter((listing) => mobileSelectedIds.has(listing.id)),
//     [mobileSelectedIds]
//   );
//   const desktopSelectedListings = useMemo(
//     () => DESKTOP_SERVICES.filter((listing) => desktopSelectedIds.has(listing.id)),
//     [desktopSelectedIds]
//   );
